...
impl<'a> Emitter<'a> {
    ...
    fn header(&mut self) {
        let contents = if cfg!(feature = "cli-help") {
            "Static parse tables and help pages"
        } else {
            "Static parse tables"
        };
        let _ = writeln!(
            ...
            "# Code generated by `usage generate ruby`. DO NOT EDIT.\n\
             # {contents} for {}. Regenerate them from the usage spec.\n\n\
             require \"usage\"\n\n\
             module {}",
